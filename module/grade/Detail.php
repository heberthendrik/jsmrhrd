...
<?php
	...
	$function_GetGradeByID = GetGradeByID($input_parameter);
	?>
...
<form action="Process.php" method="post" class="form-horizontal row-border">
	...
	<header class="panel-heading">
		<h2 class="panel-title">Data Detail Grade</h2>
	</header>
	<div class="panel-body">
				...
				<div class="block-web">
					<div class="porlets-content">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="textGrade" value="<?php echo $function_GetGradeByID['GRADE'][0]; ?>">
							</div>
						</div>
					</div>
					<!--/porlets-content-->
		...
		<input type="hidden" name="module" value="GradeDetail" />
	</div>
</form>
