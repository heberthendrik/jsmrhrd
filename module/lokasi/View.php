		...
		<tbody>
			<?php
				...
				for( $i=0;$i<$function_GetAllLokasi['TOTAL_ROW'];$i++ ){
					...
					?>
			<tr>
				<td><?php echo $function_GetAllLokasi['ID'][$i];?></td>
				<td><?php echo $function_GetAllLokasi['LOKASI'][$i];?></td>
				<td><a href="Detail.php?id=<?php echo $function_GetAllLokasi['ID'][$i];?>"><i class="fa fa-sign-in"></i> Lihat Detail</a></td>
			</tr>
			<?php
				}
				?>
