				...
				<div class="contentpanel">
					...
					<div class="container clear_both padding_fix">
						...
						<form action="Process.php" method="post" class="form-horizontal row-border">
								...
								<div class="col-md-12">
									<div class="block-web">
										<div class="header">
											...
											<h3 class="content-header">Data Detail Pengguna</h3>
										</div>
										...
										<div class="porlets-content">
											...
											<div class="form-group">
												<label class="col-sm-3 control-label">Sandi Saat Ini</label>
												<div class="col-sm-9">
													<input type="password" class="form-control" name="textPasswordCurrent" required >
												</div>
											</div>
											<div class="form-group">
							...
							<input type="hidden" name="module" value="UserCurrentChangePassword" />
						</form>
