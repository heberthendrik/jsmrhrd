...
<?php
	...
	$function_GetGolonganDarahByID = GetGolonganDarahByID($input_parameter);
	?>
...
<form action="Process.php" method="post" class="form-horizontal row-border">
	...
	<header class="panel-heading">
		<h2 class="panel-title">Data Detail Golongan Darah</h2>
	</header>
	<div class="panel-body">
				...
				<div class="block-web">
					<div class="porlets-content">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="textGolonganDarah" value="<?php echo $function_GetGolonganDarahByID['GOLONGAN_DARAH'][0]; ?>">
							</div>
						</div>
					</div>
					<!--/porlets-content-->
		...
		<input type="hidden" name="module" value="GolonganDarahDetail" />
	</div>
</form>
