...
<header class="panel-heading" style="margin-top:20px;">
	<h2 class="panel-title">Rekaptulasi Jumlah Karyawan per Jabatan dan Pendidikan Yang Dimiliki</h2>
</header>
						...
						<thead>
							<tr>
								...
								for( $i=0;$i<=$function_GetAllPendidikan['TOTAL_ROW'];$i++ ){
									?>
									<th><?php echo $function_GetAllPendidikan['PENDIDIKAN'][$i];?></th>
									<?php
								}
								?>
								<th>Total</th>
						...
						<tbody>
							...
							for( $i=0;$i<$function_GetAllJabatan['TOTAL_ROW'];$i++ ){
								...
								<tr>
									...
									for( $j=0;$j<=$function_GetAllPendidikan['TOTAL_ROW'];$j++ ){
										...
										where
											ID_PENDIDIKAN_DIMILIKI = '".$function_GetAllPendidikan['ID'][$j]."'
