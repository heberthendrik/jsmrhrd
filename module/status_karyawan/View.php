		...
		<tbody>
			<?php
				...
				for( $i=0;$i<$function_GetAllStatusKaryawan['TOTAL_ROW'];$i++ ){
					...
					?>
			<tr>
				<td><?php echo $function_GetAllStatusKaryawan['ID'][$i];?></td>
				<td><?php echo $function_GetAllStatusKaryawan['STATUS_KARYAWAN'][$i];?></td>
				<td><a href="Detail.php?id=<?php echo $function_GetAllStatusKaryawan['ID'][$i];?>"><i class="fa fa-sign-in"></i> Lihat Detail</a></td>
			</tr>
			<?php
				}
				?>
