...
<form action="Process.php" method="post" class="form-horizontal row-border">
	...
	<header class="panel-heading">
		<h2 class="panel-title">Data Pendaftaran Status Karyawan</h2>
	</header>
	<div class="panel-body">
				...
				<div class="block-web">
					<div class="porlets-content">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="textStatusKaryawan">
							</div>
						</div>
					</div>
					<!--/porlets-content-->
		...
		<!--/row--> 
		<input type="hidden" name="module" value="StatusKaryawanAdd" />
	</div>
</form>
