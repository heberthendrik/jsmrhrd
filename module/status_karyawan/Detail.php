...
<?php
	...
	$function_GetStatusKaryawanByID = GetStatusKaryawanByID($input_parameter);
	?>
<header class="page-header">
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><span>Status Karyawan</span></li>
		</ol>
...
<form action="Process.php" method="post" class="form-horizontal row-border">
	...
	<header class="panel-heading">
		<h2 class="panel-title">Data Detail Status Karyawan</h2>
	</header>
	<div class="panel-body">
				...
				<div class="block-web">
					<div class="porlets-content">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="textStatusKaryawan" value="<?php echo $function_GetStatusKaryawanByID['STATUS_KARYAWAN'][0]; ?>">
							</div>
						</div>
					</div>
					<!--/porlets-content-->
		...
		<input type="hidden" name="module" value="StatusKaryawanDetail" />
	</div>
</form>
